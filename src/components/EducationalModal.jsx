...
const EducationalModal = ({ isOpen, onClose, title, content }) => {
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm" onClick={onClose}>
        ...
        >
          <div className="bg-blue-600 p-6 flex justify-between items-start">
            ...
            <button
              onClick={onClose}
              className="text-blue-100 hover:text-white transition-colors bg-blue-700 hover:bg-blue-800 rounded-full p-1"
            >
              <X size={20} />
            </button>
          </div>
