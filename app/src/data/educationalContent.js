export const educationalContent = {
  ...
  campaignName: {
    ...
    studentNote: "Always check if your professor has a specific naming convention for assignments."
  },
  buyingType: {
    title: "Buying Type",
    ...
    studentNote: "Understanding this concept is key for your justification in the final review step."
  },
  campaignObjective: {
    ...
    studentNote: "For this simulation, think about what the hypothetical client actually wants: Clicks or Revenue?"
  },
  specialCategory: {
    ...
    studentNote: "If your ad involves housing, jobs, or credit, you MUST declare this."
  },
  ...
  budget: {
    ...
    studentNote: "Consider the duration of your campaign when choosing a budget type."
  },
  audience: {
    ...
    studentNote: "Be prepared to explain *why* you chose a specific audience in your report."
  },
  locations: {
    title: "Locations",
  ...
  creativeFormat: {
    ...
    studentNote: "Visuals are 70% of the success. Choose a format that showcases the product best."
  },
  primaryText: {
    title: "Primary Text",
    ...
    studentNote: "Write a compelling hook in the first 125 characters."
  },
  headline: {
    title: "Headline",
    ...
    studentNote: "Keep it under 40 characters to avoid truncation."
  },
  callToAction: {
    ...
    studentNote: "Match the CTA to the user's expected next step (e.g. don't use 'Shop Now' for a blog post)."
  }
};
